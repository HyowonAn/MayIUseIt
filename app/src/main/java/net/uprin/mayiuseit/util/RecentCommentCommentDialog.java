...
public class RecentCommentCommentDialog extends Dialog {
    ...
    public RecentCommentCommentDialog(Context context, RecentCommentList recentcommentList) {
        super(context);
        ...
        rating_dialog_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( commentEditText.getText().toString().length() == 0 ) {
                    ...
                    Call<Comment> call = api.write_comment(recentcommentList.getDocument_srl(), commentEditText.getText().toString());
